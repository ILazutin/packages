...
public class CircularEncoder {
    ...
    private static class EncoderThread extends Thread {
        ...
        public void run() {
            Looper.prepare();
            mHandler = new EncoderHandler(Looper.getMainLooper());    // must create on encoder thread
            mHandler.setThread(this);
...
//            ByteBuffer[] encoderOutputBuffers = mEncoder.getOutputBuffers();
        ...
        private static class EncoderHandler extends Handler {
            ...
            public EncoderHandler(@NonNull Looper looper) {
                super(looper);
            }

            public void setThread(EncoderThread et) {
